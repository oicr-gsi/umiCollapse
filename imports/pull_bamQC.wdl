...
workflow bamQC {
  ...
  input {
    ...
    parameter_meta {
        ...
        mergeFiles_modules: "required environment modules"
        mergeFiles_timeout: "hours before task timeout"
        mergeFiles_cores: "Requested CPU threads"
        mergeFiles_overhead: "Java overhead memory (in GB); jobMemory - overhead = java Xmx/heap memory"
        mergeFiles_jobMemory: "Memory allocated for this job"
        mergeFiles_suffix: "suffix to use for merged bam"
        mergeSplitByIntervalFiles_modules: "required environment modules"
        mergeSplitByIntervalFiles_timeout: "hours before task timeout"
        mergeSplitByIntervalFiles_cores: "Requested CPU threads"
        mergeSplitByIntervalFiles_overhead: "Java overhead memory (in GB); jobMemory - overhead = java Xmx/heap memory"
        mergeSplitByIntervalFiles_jobMemory: "Memory allocated for this job"
